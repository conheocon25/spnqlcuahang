<?php 
function tpl_5422748b_ReportDailyStore__asbEtTfGy9ZSV3FyF53PGA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<span><?php echo phptal_escape($ctx->path($ctx->TS, 'getOldCountPrint')); ?>
</span></td>
