<?php 
function tpl_5422d2cd_ReportDailyPaid__Yubcdkqm8rjERsdo8NcZpg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<th width="5%"><?php /* tag "B" from line 71 */; ?>
<B>#ID</B></th>
											<?php /* tag "th" from line 72 */; ?>
<th width="18%"><?php /* tag "div" from line 72 */; ?>
<div class="text-left">THỜI GIAN</div></th>
											<?php /* tag "th" from line 73 */; ?>
<th width="15%"><?php /* tag "div" from line 73 */; ?>
<div class="text-left">NHÂN VIÊN</div></th>
											<?php /* tag "th" from line 74 */; ?>
<th width="40%"><?php /* tag "div" from line 74 */; ?>
<div class="text-left">DIỄN GIẢI</div></th>
											<?php /* tag "th" from line 75 */; ?>
<th width="22%"><?php /* tag "div" from line 75 */; ?>
<div class="text-right">GIÁ TRỊ</div></th>
										</tr>
									</thead>
...
<td align="center"><?php /* tag "span" from line 80 */; ?>
<span><?php echo phptal_escape($ctx->path($ctx->Paid, 'getId')); ?>
</span></td>
											<?php /* tag "td" from line 81 */; ?>
<td align="left"><?php /* tag "span" from line 81 */; ?>
<span><?php echo phptal_escape($ctx->path($ctx->Paid, 'getDatePrint')); ?>
</span></td>
											<?php /* tag "td" from line 82 */; ?>
<td align="left"><?php /* tag "span" from line 82 */; ?>
...
<td align="right"><?php /* tag "span" from line 84 */; ?>
<span><?php echo phptal_escape($ctx->path($ctx->Paid, 'getValuePrint')); ?>
</span></td>
										</tr><?php 
endforeach ;
...
<td align="right" colspan="4"><?php /* tag "B" from line 87 */; ?>
<B>(3) = </B></td>
											<?php /* tag "td" from line 88 */; ?>
<td align="right"><?php /* tag "B" from line 88 */; ?>
...
<td align="right" colspan="4"><?php /* tag "B" from line 91 */; ?>
<B>TỔNG CỘNG = (1) + (2) + (3)</B></td>
											<?php /* tag "td" from line 92 */; ?>
<td align="right"><?php /* tag "B" from line 92 */; ?>
