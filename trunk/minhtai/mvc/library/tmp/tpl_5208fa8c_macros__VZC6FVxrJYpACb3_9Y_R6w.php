<?php 
function tpl_5208fa8c_macros__VZC6FVxrJYpACb3_9Y_R6w_MobileMenuReport(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
>CHI KHÁC</a></li>
 ...
 ?>
<?php 
function tpl_5208fa8c_macros__VZC6FVxrJYpACb3_9Y_R6w_MobileMenuMain(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
>THIẾT LẬP</a></li>
 ...
 ?>
<?php 
function tpl_5208fa8c_macros__VZC6FVxrJYpACb3_9Y_R6w_MobileMenuSettings(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="#Term" data-transition="none" data-inline="true">CHI KHÁC</a></li>
 ...
 ?>
<?php 
function tpl_5208fa8c_macros__VZC6FVxrJYpACb3_9Y_R6w_IncludeJS_Mobile(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/library/mobiscroll-2.0.2.custom.min.js"></script>
 ...
 ?>
<?php 
function tpl_5208fa8c_macros__VZC6FVxrJYpACb3_9Y_R6w_IncludeCSS_Mobile(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="stylesheet" type="text/css" href="/mvc/templates/theme/base/mobiscroll-2.0.2.custom.min.css"/>
 ...
 ?>
<?php 
function tpl_5208fa8c_macros__VZC6FVxrJYpACb3_9Y_R6w(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
...
Generated by PHPTAL from D:\AppWebServer\SPN_MinhTai\mvc\templates\macros.xhtml (edit that file instead) */; ?>