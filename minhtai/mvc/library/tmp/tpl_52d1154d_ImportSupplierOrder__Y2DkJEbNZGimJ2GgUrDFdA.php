<?php 
function tpl_52d1154d_ImportSupplierOrder__Y2DkJEbNZGimJ2GgUrDFdA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
/* tag "tr" from line 31 */ ;
$_tmp_2 = $ctx->repeat ;
$_tmp_2->Detail = new PHPTAL_RepeatController($ctx->path($ctx->Order, 'getTrackAll'))
 ;
$ctx = $tpl->pushContext() ;
...
<i class="glyphicons-fast_food modal-icon"></i>CẬP NHẬT CHI TIẾT ĐƠN HÀNG</h3>
								</div>								
								<?php /* tag "form" from line 55 */; ?>
<form id="FormSupplierOrder" action="#" class="form-horizontal" novalidate="novalidate">
...
Generated by PHPTAL from G:\AppsWeb\quanly-cuahang.com\minhtai\mvc\templates\ImportSupplierOrder.html (edit that file instead) */; ?>