<?php 
function tpl_52ceda4f_ExportCustomerOrder__F9GrB7495g2jqaLGjn0Wkg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<div class="text-right"><?php echo phptal_escape($ctx->path($ctx->SPaid, 'formatCurrency')); ?>
</div> đ</td>
