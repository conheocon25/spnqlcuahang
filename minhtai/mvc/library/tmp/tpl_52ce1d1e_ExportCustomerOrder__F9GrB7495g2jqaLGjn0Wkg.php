<?php 
function tpl_52ce1d1e_ExportCustomerOrder__F9GrB7495g2jqaLGjn0Wkg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if (null !== ($_tmp_5 = ($ctx->path($ctx->Detail, 'getgetId')))):  ;
$_tmp_5 = ' data-id="'.phptal_escape($_tmp_5).'"' ;
else:  ;
$_tmp_5 = '' ;
endif ;
?>
<span class="extra 		glyphicons-cicle_plus"<?php echo $_tmp_5 ?>
></span></td>
									</tr><?php 
endforeach ;
$ctx = $tpl->popContext() ;
