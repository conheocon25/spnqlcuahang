<?php 
function tpl_52cef6b2_ExportCustomerOrder__F9GrB7495g2jqaLGjn0Wkg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<div class="text-right"><?php echo phptal_escape($ctx->path($ctx->CL, 'getOldDebtPrint')); ?>
</div></td>
...
<div><?php echo phptal_escape($ctx->path($ctx->CL, 'getValuePrint')); ?>
</div></a>
									</td>
