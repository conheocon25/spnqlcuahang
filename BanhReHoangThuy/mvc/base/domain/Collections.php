...
interface EmployeeLoanCollection extends \Iterator {function add( Object $EmployeeLoan);}
interface EmployeeProduceCollection extends \Iterator {function add( Object $EmployeeProduce);}
interface EmployeeTrackingCollection extends \Iterator {function add( Object $EmployeeTracking);}

interface EmployeeProduceTrackingCollection extends \Iterator {function add( Object $EmployeeProduceTracking);}
interface EmployeeLoanTrackingCollection extends \Iterator {function add( Object $EmployeeLoanTracking);}
interface PriceEmployeeProduceCollection extends \Iterator {function add( Object $PriceEmployeeProduce);}
interface PriceEmployeeProduceTrackingCollection extends \Iterator {function add( Object $PriceEmployeeProduceTracking);}
interface PriceProductImportCollection extends \Iterator {function add( Object $PriceProductImport);}
interface PriceProductExportCollection extends \Iterator {function add( Object $PriceProductExport);}
interface PriceProductExportTrackingCollection extends \Iterator {function add( Object $PriceProductExportTracking);}
interface PriceResourceExportTrackingCollection extends \Iterator {function add( Object $PriceResourceExportTracking);}
interface PriceResourceExportCollection extends \Iterator {function add( Object $PriceResourceExport);}
interface PriceResourceImportTrackingCollection extends \Iterator {function add( Object $PriceResourceImportTracking);}
...
interface CustomerPaidCollection extends \Iterator {function add( Object $CustomerPaid);}
interface CustomerPaidTrackingCollection extends \Iterator {function add( Object $CustomerPaidTracking );}
interface CustomerLoanCollection extends \Iterator {function add( Object $CustomerLoan);}
...
interface SupplierDebtCollection extends \Iterator {function add( Object $supplierdebt );	}
?>
