<?php		
	...
	class MoneyPaidCustomer extends Command {
		function doExecute( \MVC\Controller\Request $request ){
			...
			$CollectAll = $mPaidCustomer->findByPage(array($IdCustomer, $Page, $Config->getValue() ));
			$PN = new \MVC\Domain\PageNavigation( $Customer->getCollectAll()->count(), $Config->getValue(), $Customer->getURLPaid());
