<?php 
function tpl_52ce6ed9_ExportCustomerOrder__F9GrB7495g2jqaLGjn0Wkg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<div class="text-right">TỔNG ĐƠN HÀNG</div></td>
...
<div class="text-right">TỔNG GIẢM GIÁ</div></td>
...
<div class="modal-footer">
										<?php /* tag "button" from line 141 */; ?>
<button id="URLUpdButton" class="btn btn-primary btn-small" type="submit" value="Validate"><?php /* tag "i" from line 141 */; ?>
<i class="glyphicons-download_alt"></i> Lưu</button>
										<?php /* tag "button" from line 142 */; ?>
<button data-dismiss="modal" class="btn btn-default btn-small"><?php /* tag "i" from line 142 */; ?>
...
<button id="URLUpdDiscountButton" class="btn btn-primary btn-small" type="submit" value="Validate"><?php /* tag "i" from line 181 */; ?>
<i class="glyphicons-download_alt"></i> Lưu</button>
