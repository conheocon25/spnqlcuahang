<?php 
function tpl_52a03750_SettingCustomerUpdLo__CbQK21Pd7TZLCARA2vLJwg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if (null !== ($_tmp_3 = ($ctx->Type['Name'][0]))):  ;
$_tmp_3 = ' value="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
...
if (null !== ($_tmp_4 = ($ctx->Type['Name'][1]))):  ;
