<?php 
function tpl_54211e86_Export__XAJFAny2TPjbAv2bvpR54A(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td><?php 
/* tag "a" from line 30 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->Supplier, 'getURLExport')))):  ;
...
<span><?php echo phptal_escape($ctx->path($ctx->Supplier, 'getOrderExportAll/count')); ?>
</span>)</a></td>
									</tr><?php 
endforeach ;
$ctx = $tpl->popContext() ;
