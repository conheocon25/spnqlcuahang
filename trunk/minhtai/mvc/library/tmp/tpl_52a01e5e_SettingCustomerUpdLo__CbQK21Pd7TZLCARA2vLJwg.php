<?php 
function tpl_52a01e5e_SettingCustomerUpdLo__CbQK21Pd7TZLCARA2vLJwg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if (null !== ($_tmp_3 = ($ctx->path($ctx->Customer, 'getType')))):  ;
$_tmp_3 = ' value="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
...
if (null !== ($_tmp_4 = ($ctx->path($ctx->Customer, 'getAlias')))):  ;
$_tmp_4 = ' value="'.phptal_escape($_tmp_4).'"' ;
else:  ;
$_tmp_4 = '' ;
endif ;
?>
<input id="Alias" name="Alias" type="text" class="required minlength:5"<?php echo $_tmp_4 ?>
/>
					</div>
...
if (null !== ($_tmp_3 = ($ctx->path($ctx->Customer, 'getAddress')))):  ;
$_tmp_3 = ' value="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
?>
<input id="Address" name="Address" type="text" class="required minlength:5"<?php echo $_tmp_3 ?>
/>
					</div>
					<?php /* tag "div" from line 46 */; ?>
<div data-role="fieldcontain">
						<?php /* tag "label" from line 47 */; ?>
<label for="Note" class="text">Ghi chú:</label>
						<?php 
/* tag "input" from line 48 */ ;
if (null !== ($_tmp_4 = ($ctx->path($ctx->Customer, 'getNote')))):  ;
$_tmp_4 = ' value="'.phptal_escape($_tmp_4).'"' ;
else:  ;
$_tmp_4 = '' ;
endif ;
?>
<input id="Note" name="Note" type="text" class="required minlength:5"<?php echo $_tmp_4 ?>
/>
					</div>
