<?php 
function tpl_52a1415d_Selling__N12li5RBtQCsdBgpd8C5Xw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if (null !== ($_tmp_3 = ($ctx->path($ctx->Customer1, 'getIdPrint')))):  ;
$_tmp_3 = ' id="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
if (null !== ($_tmp_4 = ($ctx->Customer1->getId()==$ctx->Customer->getId()?'a':'c'))):  ;
$_tmp_4 = ' data-theme="'.phptal_escape($_tmp_4).'"' ;
else:  ;
$_tmp_4 = '' ;
endif ;
?>
<li class="customer"<?php echo $_tmp_3 ?>
<?php echo $_tmp_4 ?>
>
							<?php 
/* tag "a" from line 38 */ ;
if (null !== ($_tmp_6 = ($ctx->path($ctx->Customer1, 'getURLSelling')))):  ;
$_tmp_6 = ' href="'.phptal_escape($_tmp_6).'"' ;
else:  ;
$_tmp_6 = '' ;
endif ;
?>
<a data-transition="none"<?php echo $_tmp_6 ?>
>
...
Generated by PHPTAL from D:\AppWebServer\SPN_MinhTai\mvc\templates\Selling.html (edit that file instead) */; ?>