<?php 
function tpl_52a0397f_SettingCustomerUpdLo__CbQK21Pd7TZLCARA2vLJwg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if ($ctx->Customer->getType()==$ctx->IdType?true:false):  ;
...
if (null !== ($_tmp_3 = ($ctx->Types[$ctx->IdType]['Id']))):  ;
$_tmp_3 = ' value="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
