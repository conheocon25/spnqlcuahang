<?php 
function tpl_52d753af_ExportCustomerOrder__F9GrB7495g2jqaLGjn0Wkg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td><?php /* tag "span" from line 124 */; ?>
<span class="text-right"><?php echo phptal_escape($ctx->path($ctx->CL, 'getOldDebtValuePrint')); ?>
</span> đ</td>
...
<td><?php /* tag "span" from line 129 */; ?>
<span class="text-right"><?php echo phptal_escape($ctx->path($ctx->CL, 'getPaidValuePrint')); ?>
</span> đ</td>
...
<div><?php echo phptal_escape($ctx->path($ctx->CL, 'getDebtValuePrint')); ?>
</div></a>
									</td>
