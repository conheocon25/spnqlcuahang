<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ_ReportHeader(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<td width="50%" align="left"></td>
 ...
 ?>
<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ_StyleTools(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="/setting/theme/red-green" alt="#red-green" style="background-image:url('/mvc/templates/theme/cms/img/demo/red-green.png');background-repeat:no-repeat;cursor:pointer;"></a>
 ...
 ?>
<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="https://www.spn-soft.com">SPN Group</a>
 ...
 ?>
<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ_MenuSetting(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="glyphicons-cogwheel"></i>CẤU HÌNH
 ...
 ?>
<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ_MenuApp(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="glyphicons-keys"></i>ĐỔI MẬT KHẨU</a>
 ...
 ?>
<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ_PageBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ_ContentHeader(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ_LocationBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="current"><?php echo phptal_escape($ctx->Title); ?>
 ...
 ?>
<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<span class="text"><?php echo phptal_escape(\MVC\Base\SessionRegistry::instance()->getCurrentUser()->getEmail()); ?>
 ...
 ?>
<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script src="/mvc/templates/theme/cms/js/jquery.flot.categories.js"></script>
 ...
 ?>
<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
/>
 ...
 ?>
<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ_IncludeMETA(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="shortcut icon" type="image/png" href="/data/images/app/icon.png"/>
 ...
 ?>
<?php 
function tpl_54211c8c_mAdmin__bKAclXWmNlxiialDuga1WQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
