...
--
-- Host: localhost
-- Generation Time: Oct 23, 2013 at 10:51 AM
...
(1, 'Nhân Viên 011', '', 1, '0989 111 2221', 'Phường 1 - Tp Vĩnh Long1'),
...
CREATE TABLE IF NOT EXISTS `sieuthimini_order_import` (
  ...
  PRIMARY KEY (`id`),
  KEY `sieuthimini_order_import_1` (`idsupplier`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `sieuthimini_order_import_detail` (
  ...
  `price` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `sieuthimini_order_import_detail_1` (`idorder`),
...
CREATE TABLE IF NOT EXISTS `sieuthimini_paid_pay_roll` (
  ...
  `note` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `sieuthimini_paid_pay_roll_1` (`idemployee`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `sieuthimini_paid_supplier` (
  ...
  `note` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `sieuthimini_supplier_paid_1` (`idsupplier`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `sieuthimini_r2t` (
  ...
  PRIMARY KEY (`id`),
  KEY `sieuthimini_r2t_1` (`id_resource`),
  KEY `sieuthimini_r2t_2` (`id_tag`)
...
CREATE TABLE IF NOT EXISTS `sieuthimini_resource` (
  ...
  PRIMARY KEY (`id`),
  KEY `sieuthimini_resource_1` (`idsupplier`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1232 ;
...
INSERT INTO `sieuthimini_resource` (`id`, `idsupplier`, `name`, `name_short`, `unit`, `price_import`, `price_export`, `description`, `barcode`) VALUES
(1, 1, 'Cà phê Wake Up hương chồn(18 gói x 17g)', '', 'Gói', 0, 42000, '', ''),
(2, 1, 'Cà phê Wake Up Sài Gòn(24 gói x 19g)', '', 'Gói', 0, 40000, '', ''),
...
--
-- Table structure for table `sieuthimini_term_paid`
--

CREATE TABLE IF NOT EXISTS `sieuthimini_term_paid` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `type` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `sieuthimini_term_paid`
--

INSERT INTO `sieuthimini_term_paid` (`id`, `name`, `type`) VALUES
(1, 'Tiền Điện', 0),
(2, 'Tiền Nước', 0),
(3, 'Thuế', 0),
(4, 'Lương Nhân Viên', 0),
...
ALTER TABLE `sieuthimini_paid_general`
  ADD CONSTRAINT `sieuthimini_paid_general_1` FOREIGN KEY (`id_term`) REFERENCES `sieuthimini_term_paid` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
