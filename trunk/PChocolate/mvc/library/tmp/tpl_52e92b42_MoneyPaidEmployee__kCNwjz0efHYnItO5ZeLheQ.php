<?php 
function tpl_52e92b42_MoneyPaidEmployee__kCNwjz0efHYnItO5ZeLheQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
/* tag "li" from line 13 */ ;
$_tmp_1 = $ctx->repeat ;
$_tmp_1->Employee1 = new PHPTAL_RepeatController($ctx->EmployeeAll)
 ;
$ctx = $tpl->pushContext() ;
foreach ($_tmp_1->Employee1 as $ctx->Employee1): ;
if (null !== ($_tmp_2 = ($ctx->Employee1->getId()==$ctx->Employee->getId()?'active':'disable'))):  ;
...
>
					<?php 
/* tag "a" from line 14 */ ;
if (null !== ($_tmp_3 = ($ctx->path($ctx->Employee1, 'getURLPaid')))):  ;
...
?>
<div Id="IdEmployee" class="row"<?php echo $_tmp_3 ?>
>
...
<i class="glyphicons-disk_open modal-icon"></i>THÊM ỨNG LƯƠNG</h3></div>
...
<i class="glyphicons-disk_open modal-icon"></i>CẬP NHẬT ỨNG LƯƠNG</h3>
								</div>
...
Generated by PHPTAL from G:\AppsWeb\quanly-cuahang.com\PChocolate\mvc\templates\MoneyPaidEmployee.html (edit that file instead) */; ?>