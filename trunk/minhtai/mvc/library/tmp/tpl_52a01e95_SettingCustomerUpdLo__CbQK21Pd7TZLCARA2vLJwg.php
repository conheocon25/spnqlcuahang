<?php 
function tpl_52a01e95_SettingCustomerUpdLo__CbQK21Pd7TZLCARA2vLJwg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if ($ctx->Customer->getType()==$ctx->Types[($ctx->Customer->getType())]['Id']?true:false):  ;
...
<span><?php echo phptal_escape($ctx->path($ctx->lst, 'Name')); ?>
</span>
							</option><?php 
endforeach ;
$ctx = $tpl->popContext() ;
...
if (null !== ($_tmp_3 = ($ctx->path($ctx->Customer, 'getAlias')))):  ;
$_tmp_3 = ' value="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
?>
<input id="Alias" name="Alias" type="text" class="required minlength:5"<?php echo $_tmp_3 ?>
/>
					</div>
...
if (null !== ($_tmp_4 = ($ctx->path($ctx->Customer, 'getPhone')))):  ;
$_tmp_4 = ' value="'.phptal_escape($_tmp_4).'"' ;
else:  ;
$_tmp_4 = '' ;
endif ;
?>
<input id="Phone" name="Phone" type="text" class="required minlength:5"<?php echo $_tmp_4 ?>
/>
					</div>
...
if (null !== ($_tmp_3 = ($ctx->path($ctx->Customer, 'getNote')))):  ;
$_tmp_3 = ' value="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
?>
<input id="Note" name="Note" type="text" class="required minlength:5"<?php echo $_tmp_3 ?>
/>
					</div>
...
if (null !== ($_tmp_4 = ($ctx->path($ctx->Customer, 'getDebt')))):  ;
$_tmp_4 = ' value="'.phptal_escape($_tmp_4).'"' ;
else:  ;
$_tmp_4 = '' ;
endif ;
?>
<input id="Debt" name="Debt" type="text" class="required minlength:5"<?php echo $_tmp_4 ?>
/>
					</div>
				</fieldset>
