<?php 
function tpl_52a032b3_SettingCustomerUpdLo__CbQK21Pd7TZLCARA2vLJwg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if ($ctx->Customer->getType()==$ctx->IdType['Id']?true:false):  ;
