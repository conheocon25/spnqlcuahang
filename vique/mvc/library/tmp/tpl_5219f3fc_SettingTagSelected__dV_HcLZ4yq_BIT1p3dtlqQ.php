<?php 
function tpl_5219f3fc_SettingTagSelected__dV_HcLZ4yq_BIT1p3dtlqQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
/* tag "tr" from line 28 */ ;
$_tmp_1 = $ctx->repeat ;
$_tmp_1->TagSelected = new PHPTAL_RepeatController($ctx->TagSelectedAll1)
 ;
$ctx = $tpl->pushContext() ;
foreach ($_tmp_1->TagSelected as $ctx->TagSelected): ;
?>
<tr>
										<?php /* tag "td" from line 29 */; ?>
<td><?php /* tag "div" from line 29 */; ?>
<div><?php echo phptal_escape($ctx->path($ctx->repeat, 'TagSelected/number')); ?>
</div></td>
										<?php /* tag "td" from line 30 */; ?>
<td><?php /* tag "div" from line 30 */; ?>
<div><?php echo phptal_escape($ctx->path($ctx->TagSelected, 'getTag/getName')); ?>
</div></td>
										<?php /* tag "td" from line 31 */; ?>
<td><?php 
/* tag "a" from line 31 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->TagSelected, 'getURLDelLoad')))):  ;
...
<a class="btn" href="/setting/tagselected/ins/load">
...
Generated by PHPTAL from I:\quanly-cuahang\vique\mvc\templates\SettingTagSelected.html (edit that file instead) */; ?>