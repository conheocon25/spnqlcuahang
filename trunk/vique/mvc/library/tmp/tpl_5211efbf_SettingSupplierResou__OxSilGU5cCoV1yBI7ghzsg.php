<?php 
function tpl_5211efbf_SettingSupplierResou__OxSilGU5cCoV1yBI7ghzsg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<script type="text/javascript">
			...
			$(document).ready(function () {
				$('#Barcode').keyup(function (){
					...
					if (str.length <9){
						$('#BarcodeMessage').html("Ít nhất 9 kí tự");						
					}else{
						URL = "/barcode/"+str;
						$.ajax({
							type: "POST",
...
<div class="controls">
								<?php /* tag "select" from line 66 */; ?>
<select name="Unit" id="Unit">
									<?php 
/* tag "option" from line 67 */ ;
$_tmp_4 = $ctx->repeat ;
$_tmp_4->Unit = new PHPTAL_RepeatController($ctx->UnitAll)
 ;
$ctx = $tpl->pushContext() ;
foreach ($_tmp_4->Unit as $ctx->Unit): ;
...
if (null !== ($_tmp_2 = ($ctx->path($ctx->Resource, 'getPriceImport')))):  ;
$_tmp_2 = ' value="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
?>
<input id="PriceImport" name="PriceImport" type="text"<?php echo $_tmp_2 ?>
/>
							</div>
						</div>
...
if (null !== ($_tmp_3 = ($ctx->path($ctx->Resource, 'getPriceExport')))):  ;
$_tmp_3 = ' value="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
?>
<input id="PriceExport" name="PriceExport" type="text"<?php echo $_tmp_3 ?>
/>
							</div>
						</div>
...
if (null !== ($_tmp_4 = ($ctx->path($ctx->Resource, 'getDescription')))):  ;
$_tmp_4 = ' value="'.phptal_escape($_tmp_4).'"' ;
else:  ;
$_tmp_4 = '' ;
endif ;
?>
<input id="Description" name="Description" type="text"<?php echo $_tmp_4 ?>
/>	
							</div>
						</div>
...
if (null !== ($_tmp_2 = ($ctx->path($ctx->Resource, 'getBarcode')))):  ;
$_tmp_2 = ' value="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
?>
<input id="Barcode" name="Barcode" type="text"<?php echo $_tmp_2 ?>
/>
