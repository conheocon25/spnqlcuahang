<?php 
function tpl_52150896_SettingUser__BatQmFUHNJXAduIcBq8AwA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<div><?php echo phptal_escape($ctx->path($ctx->repeat, 'User/number')); ?>
</div>
										</td>
...
<td>
											<?php 
/* tag "a" from line 33 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->User, 'getURLUpdLoad')))):  ;
...
<div><?php echo phptal_escape($ctx->path($ctx->User, 'getName')); ?>
</div>
											</a>
										</td>										
...
<td width="32">
											<?php 
/* tag "a" from line 38 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->User, 'getURLDelLoad')))):  ;
$_tmp_2 = ' href="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
<a class="btn" href="/setting/user/ins/load">
...
Generated by PHPTAL from I:\quanly-cuahang\vique\mvc\templates\SettingUser.html (edit that file instead) */; ?>