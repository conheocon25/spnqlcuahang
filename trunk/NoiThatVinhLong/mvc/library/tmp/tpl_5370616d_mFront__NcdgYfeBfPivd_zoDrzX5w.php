<?php 
function tpl_5370616d_mFront__NcdgYfeBfPivd_zoDrzX5w_AdsService(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
?>
 ...
 ?>
<?php 
function tpl_5370616d_mFront__NcdgYfeBfPivd_zoDrzX5w_OptionPanel(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<option value="Nunito">Nunito</option>
 ...
 ?>
<?php 
function tpl_5370616d_mFront__NcdgYfeBfPivd_zoDrzX5w_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<strong>Trung tâm điện máy Minh Hoàng</strong></li>
...
<i class="fa fa-angle-up"></i></a>
 ...
 ?>
<?php 
function tpl_5370616d_mFront__NcdgYfeBfPivd_zoDrzX5w_LocationBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<li class="active"><?php echo phptal_escape($ctx->Title); ?>
 ...
 ?>
<?php 
function tpl_5370616d_mFront__NcdgYfeBfPivd_zoDrzX5w_Menu(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="/lien-he">Liên hệ</a>
 ...
 ?>
<?php 
function tpl_5370616d_mFront__NcdgYfeBfPivd_zoDrzX5w_PageTitle(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<p><?php echo phptal_escape($ctx->path($ctx->ConfigSlogan, 'getValue')); ?>
 ...
 ?>
<?php 
function tpl_5370616d_mFront__NcdgYfeBfPivd_zoDrzX5w_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="/gio-hang" title="My Cart"><?php /* tag "span" from line 72 */; ?>
...
<p class="header-text">
									Trung tâm điện máy Minh Hoàng xin kính chào quý khách! Với các mặt hàng chất lượng chính hãng, phong phú, đa dạng đến từ đầy đủ các ngành hàng như Vi tính, Giải trí số, Điện tử, Điện lạnh, Gia dụng cùng phong cách phục vụ chuyên nghiệp, chu đáo, Điện máy Minh Hoàng hứa hẹn sẽ là điểm đến tham quan, mua sắm lý tưởng cho mọi gia đình
								</p>
							</div><!-- End .pull-right -->
...
<span>Điện máy Minh Hoàng</span>
							<?php /* tag "a" from line 102 */; ?>
<a href="/" title="Điện máy Minh Hoàng"><?php /* tag "img" from line 102 */; ?>
<img src="/mvc/templates/front/images/logo.png" alt="Điện máy Minh Hoàng" width="238" height="76"/></a>
						</h1>
					</div><!-- End .col-md-5 -->
...
<button type="submit" id="quick-search" class="btn btn-custom"></button>
 ...
 ?>
<?php 
function tpl_5370616d_mFront__NcdgYfeBfPivd_zoDrzX5w_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script src="/mvc/templates/front/js/jquery.mlens-1.3.min.js"></script>
 ...
 ?>
<?php 
function tpl_5370616d_mFront__NcdgYfeBfPivd_zoDrzX5w_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="stylesheet" href="/mvc/templates/front/css/responsive.css"/>
 ...
 ?>
<?php 
function tpl_5370616d_mFront__NcdgYfeBfPivd_zoDrzX5w_IncludeMETA(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<meta name="keywords" content="Website Điện Máy Minh Hoàng"/>
		<?php /* tag "meta" from line 15 */; ?>
<meta name="description" content="Website Điện Máy Minh Hoàng"/>
		<?php /* tag "meta" from line 16 */; ?>
<meta name="page-topic" content="Website Điện Máy Minh Hoàng"/>
		<?php /* tag "meta" from line 17 */; ?>
<meta name="Abstract" content="Website Điện Máy Minh Hoàng"/>
		<?php /* tag "meta" from line 18 */; ?>
<meta name="classification" content="Website Điện Máy Minh Hoàng"/>
...
<link rel="shortcut icon" type="image/png" href="/data/images/icon.ico"/>
 ...
 ?>
<?php 
function tpl_5370616d_mFront__NcdgYfeBfPivd_zoDrzX5w(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
...
Generated by PHPTAL from G:\AppsWeb\quanly-cuahang.com\DienMayMinhHoang\mvc\templates\mFront.xhtml (edit that file instead) */; ?>