<?php 
function tpl_52e92a9e_MoneyPaidGeneral__dJmRmBY3CXk1aWbOPEypTA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
/* tag "li" from line 13 */ ;
$_tmp_1 = $ctx->repeat ;
$_tmp_1->Term1 = new PHPTAL_RepeatController($ctx->TermAll)
 ;
$ctx = $tpl->pushContext() ;
foreach ($_tmp_1->Term1 as $ctx->Term1): ;
if (null !== ($_tmp_2 = ($ctx->Term1->getId()==$ctx->Term->getId()?'active':'disable'))):  ;
...
>
					<?php 
/* tag "a" from line 14 */ ;
if (null !== ($_tmp_3 = ($ctx->path($ctx->Term1, 'getURLDetail')))):  ;
...
<i class="glyphicons-disk_open"></i> <?php /* tag "span" from line 15 */; ?>
...
if (null !== ($_tmp_3 = ($ctx->path($ctx->Term, 'getId')))):  ;
$_tmp_3 = ' alt="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
?>
<div Id="IdTerm" class="row"<?php echo $_tmp_3 ?>
>
...
?>
<a class="update-item" href="#DialogEdit" data-toggle="modal" data-name="PaidGeneral"<?php echo $_tmp_1 ?>
...
<i class="glyphicons-disk_open modal-icon"></i>THÊM KHOẢN CHI</h3></div>
...
<button id="URLUpdButton" class="btn btn-primary btn-small"><?php /* tag "i" from line 128 */; ?>
<i class="glyphicons-download_alt"></i> Lưu</button>
...
<script type="text/javascript">
		/*<![CDATA[*/			
			...
			$('#URLDelSelectedButton').click(function(){
				var count = 0;
				var Data = [];
				var URL = "/object/del/PaidGeneral/0";
			...
			$('#URLDelButton').click(function(){			
				var URL = "/object/del/PaidGeneral/" + $(this).attr('alt');
				$.ajax({
					type: "POST",					
					url: URL,
					success: function(msg){
			...
			$('#URLInsButton').click(function(){
				var Data = [];
				Data[0] = 'null';
				Data[1] = $('#IdTerm').attr('alt');
				Data[2] = $('#Date1').val();
				Data[3] = $('#Value1').val();
				Data[4] = $('#Note1').val();
																		
				var URL = "/object/ins/PaidGeneral";
				$.ajax({
					type: "POST",
					data: {Data:Data},
					url: URL,
			...
			$('.update-item').click(function(){
				...
				var url = "/object/load/PaidGeneral/" + $(this).attr('data-id');
			...
			$('#URLUpdButton').click(function(){
				...
				var URL = "/object/upd/PaidGeneral";
				$.ajax({
					type: "POST",
					data: {Data:Data},
					url: URL,
...
Generated by PHPTAL from G:\AppsWeb\quanly-cuahang.com\PChocolate\mvc\templates\MoneyPaidGeneral.html (edit that file instead) */; ?>