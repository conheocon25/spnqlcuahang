<?php 
function tpl_54227f0a_ReportDetailStore__1RtnM_Lg8HfUKH0RCbVV9Q(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<span><?php echo phptal_escape($ctx->path($ctx->TS, 'getCountRemainPrint')); ?>
</span></td>
												<?php /* tag "td" from line 43 */; ?>
<td align="right"><?php /* tag "span" from line 43 */; ?>
<span><?php echo phptal_escape($ctx->path($ctx->TS, 'getCountRemainValuePrint')); ?>
</span></td>
											</tr><?php 
endforeach ;
$ctx = $tpl->popContext() ;
...
<td colspan="8" align="left"><?php /* tag "B" from line 46 */; ?>
<B>TỔNG CỘNG</B></td>
												<?php /* tag "td" from line 47 */; ?>
<td align="right"><?php /* tag "B" from line 47 */; ?>
<B><?php echo phptal_escape($ctx->path($ctx->Sum, 'formatCurrency')); ?>
</B></td>
											</tr>
										</tbody>
									</table>
...
Generated by PHPTAL from G:\AppsWeb\quanly-cuahang.com\PChocolate\mvc\templates\ReportDetailStore.html (edit that file instead) */; ?>