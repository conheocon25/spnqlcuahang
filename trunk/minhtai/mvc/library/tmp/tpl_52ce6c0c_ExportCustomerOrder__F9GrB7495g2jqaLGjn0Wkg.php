<?php 
function tpl_52ce6c0c_ExportCustomerOrder__F9GrB7495g2jqaLGjn0Wkg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td colspan="5"><?php /* tag "div" from line 87 */; ?>
<div class="text-right"><?php echo 'TỔNG CỘNG'; ?>
</div></td>
...
<button id="URLUpdDiscountButton" class="btn btn-primary btn-small" type="submit" value="Validate"><?php /* tag "i" from line 167 */; ?>
<i class="glyphicons-download_alt"></i> Lưu</button>
