<?php 
function tpl_52d75073_ExportCustomerOrder__F9GrB7495g2jqaLGjn0Wkg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<div class="text-right"><?php echo phptal_escape($ctx->path($ctx->CL, 'getOldDebtValuePrint')); ?>
</div></td>
...
<div class="text-right"><?php echo phptal_escape($ctx->path($ctx->CL, 'getPaidValuePrint')); ?>
</div></td>
