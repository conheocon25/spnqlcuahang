...
class CustomerLoan extends Object{
	...
	/*--------------------------------------------------------------------*/	
	function getURLUpdate(){return "?cmd=UpdateCustomerLoan&IdCustomerLoan=".$this->Id."&IdCustomer=".$this->IdCustomer;}
	function getURLDelete(){return "?cmd=DeleteCustomerLoan&IdCustomerLoan=".$this->Id."&IdCustomer=".$this->IdCustomer;}
}
?>