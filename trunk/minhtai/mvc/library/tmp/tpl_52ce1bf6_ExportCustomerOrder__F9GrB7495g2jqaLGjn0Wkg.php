<?php 
function tpl_52ce1bf6_ExportCustomerOrder__F9GrB7495g2jqaLGjn0Wkg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td class="center"><?php /* tag "div" from line 75 */; ?>
<div><?php echo phptal_escape($ctx->path($ctx->repeat, 'Detail/number')); ?>
</div></td>
...
?>
<span class="discount glyphicons-remove_2"<?php echo $_tmp_6 ?>
></span></td>
									</tr><?php 
endforeach ;
$ctx = $tpl->popContext() ;
...
<td colspan="5"><?php /* tag "div" from line 84 */; ?>
<div class="text-right"><?php echo 'TỔNG CỘNG'; ?>
</div></td>
										<?php /* tag "td" from line 85 */; ?>
<td><?php /* tag "div" from line 85 */; ?>
...
<button id="URLUpdButton" class="btn btn-primary btn-small" type="submit" value="Validate"><?php /* tag "i" from line 125 */; ?>
...
if (null !== ($_tmp_7 = ($ctx->path($ctx->Order, 'getId')))):  ;
$_tmp_7 = ' alt="'.phptal_escape($_tmp_7).'"' ;
else:  ;
$_tmp_7 = '' ;
endif ;
?>
<div id="IdOrder"<?php echo $_tmp_7 ?>
></div>
		<?php 
