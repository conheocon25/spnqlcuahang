<?php 
function tpl_52a036ff_SettingCustomerUpdLo__CbQK21Pd7TZLCARA2vLJwg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if (null !== ($_tmp_4 = ($ctx->Type['Name'][0]))):  ;
