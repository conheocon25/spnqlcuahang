<?php 
function tpl_52ceff1b_ExportCustomerOrder__F9GrB7495g2jqaLGjn0Wkg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<div class="text-right"><?php echo phptal_escape($ctx->path($ctx->CL, 'getDebtOldValuePrint')); ?>
</div></td>
