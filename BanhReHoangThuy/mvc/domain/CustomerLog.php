...
class CustomerLog extends Object{
	...
	//-------------------------------------------------------------------------
    function __construct( $Id=null, $IdCustomer=null, $DateStart=null, $DateEnd=null, $Note=null) {
        $this->Id = $Id;		
	...
	/*--------------------------------------------------------------------*/	
	function getURLUpdate(){return "?cmd=UpdateCustomerLog&IdLog=".$this->Id;}
	function getURLDelete(){return "?cmd=DeleteCustomerLog&IdLog=".$this->Id;}
	function getURLViewTracking(){return "?cmd=PrintCustomerTracking&IdCustomer=".$this->IdCustomer."&DateStart=".$this->DateStart."&DateEnd=".$this->DateEnd;}
	function getURLViewTracking1(){return "?cmd=PrintCustomerTracking1&IdCustomer=".$this->IdCustomer."&DateStart=".$this->DateStart."&DateEnd=".$this->DateEnd;}
}
?>