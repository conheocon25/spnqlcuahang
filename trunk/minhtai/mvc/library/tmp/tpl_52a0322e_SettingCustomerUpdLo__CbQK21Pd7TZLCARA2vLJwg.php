<?php 
function tpl_52a0322e_SettingCustomerUpdLo__CbQK21Pd7TZLCARA2vLJwg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if ($ctx->Customer->getType()==$ctx->Types['(Customer->getType())']['Id']?true:false):  ;
