<?php 
function tpl_54213470_ReportDailyStore__asbEtTfGy9ZSV3FyF53PGA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<span><?php echo phptal_escape($ctx->TD->getImportCount( $ctx->Resource->getId() )|0); ?>
</span></td>
												<?php /* tag "td" from line 40 */; ?>
<td align="right"><?php /* tag "span" from line 40 */; ?>
<span><?php echo phptal_escape($ctx->TD->getExportCount( $ctx->Resource->getId() )|0); ?>
</span></td>
