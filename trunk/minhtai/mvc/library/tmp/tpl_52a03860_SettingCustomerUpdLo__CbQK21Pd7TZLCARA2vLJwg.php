<?php 
function tpl_52a03860_SettingCustomerUpdLo__CbQK21Pd7TZLCARA2vLJwg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if ($ctx->Customer->getType()==$ctx->Type[$ctx->Customer->getType()]?true:false):  ;
