<?php 
function tpl_521e45c8_SettingBarcodeNone__CvLKkSwxx1sNaPG1RHhvqA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
/* tag "tr" from line 37 */ ;
$_tmp_1 = $ctx->repeat ;
$_tmp_1->Resource = new PHPTAL_RepeatController($ctx->ResourceBarcode)
 ;
$ctx = $tpl->pushContext() ;
