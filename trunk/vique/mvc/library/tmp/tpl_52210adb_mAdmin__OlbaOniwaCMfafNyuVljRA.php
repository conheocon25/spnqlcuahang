<?php 
function tpl_52210adb_mAdmin__OlbaOniwaCMfafNyuVljRA_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<span class="label pull-right copyright">&#169; 2012 SPN</span>
 ...
 ?>
<?php 
function tpl_52210adb_mAdmin__OlbaOniwaCMfafNyuVljRA_Menu(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a<?php echo $_tmp_1 ?>
>
					<?php /* tag "i" from line 88 */; ?>
<i class="icon-user"></i>
					NHÀ CUNG CẤP<?php /* tag "span" from line 89 */; ?>
...
<i class="icon-user"></i>
					NGƯỜI DÙNG<?php /* tag "span" from line 95 */; ?>
...
<i class="icon-user"></i>
					KHÁCH HÀNG<?php /* tag "span" from line 101 */; ?>
...
<i class="icon-th"></i>
					ĐƠN VỊ TÍNH<?php /* tag "span" from line 107 */; ?>
...
<i class="icon-tag"></i>
					THẺ<?php /* tag "span" from line 113 */; ?>
...
<i class="icon-tag"></i>
					THẺ ĐƯỢC CHỌN<?php /* tag "span" from line 119 */; ?>
...
<i class="icon-wrench"></i>
					CẤU HÌNH<?php /* tag "span" from line 125 */; ?>
<span class="badge badge-info pull-right"><?php echo phptal_escape($ctx->path($ctx->ConfigAll, 'count')); ?>
 ...
 ?>
<?php 
function tpl_52210adb_mAdmin__OlbaOniwaCMfafNyuVljRA_PageBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_52210adb_mAdmin__OlbaOniwaCMfafNyuVljRA_LocationBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<li class="active"><?php echo phptal_escape($ctx->Title); ?>
 ...
 ?>
<?php 
function tpl_52210adb_mAdmin__OlbaOniwaCMfafNyuVljRA_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="brand" href="/app"><?php /* tag "i" from line 50 */; ?>
<i class="icon-shopping-cart" style="font-size:2em; color:white;"></i> Siêu thị mini tự chọn Vị Quê</a>
...
<span><?php echo phptal_escape(\MVC\Base\SessionRegistry::instance()->getCurrentUser()->getEmail()); ?>
 ...
 ?>
<?php 
function tpl_52210adb_mAdmin__OlbaOniwaCMfafNyuVljRA_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script type="text/javascript" language="javascript" src="/mvc/templates/theme/bootstrap/js/bootstrap-datepicker.js"></script>
 ...
 ?>
<?php 
function tpl_52210adb_mAdmin__OlbaOniwaCMfafNyuVljRA_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="stylesheet" type="text/css" href="/mvc/templates/theme/bootstrap/css/font-awesome.min.css"/>
 ...
 ?>
<?php 
function tpl_52210adb_mAdmin__OlbaOniwaCMfafNyuVljRA_IncludeMETA(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="icon" type="image/png" href="/data/images/icon.png"/>
 ...
 ?>
<?php 
function tpl_52210adb_mAdmin__OlbaOniwaCMfafNyuVljRA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
