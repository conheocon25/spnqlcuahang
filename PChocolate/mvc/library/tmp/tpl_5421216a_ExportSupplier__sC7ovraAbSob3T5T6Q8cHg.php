<?php 
function tpl_5421216a_ExportSupplier__sC7ovraAbSob3T5T6Q8cHg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
>
					<?php 
/* tag "a" from line 14 */ ;
if (null !== ($_tmp_3 = ($ctx->path($ctx->Supplier1, 'getURLExport')))):  ;
...
Generated by PHPTAL from G:\AppsWeb\quanly-cuahang.com\PChocolate\mvc\templates\ExportSupplier.html (edit that file instead) */; ?>