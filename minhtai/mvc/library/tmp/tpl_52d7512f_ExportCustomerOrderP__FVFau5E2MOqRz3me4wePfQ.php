<?php 
function tpl_52d7512f_ExportCustomerOrderP__FVFau5E2MOqRz3me4wePfQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td align="right"><?php /* tag "B" from line 97 */; ?>
<B>NỢ MỚI:</B></td>
			<?php /* tag "td" from line 98 */; ?>
<td align="right"><?php /* tag "font" from line 98 */; ?>
<font size="14px"><?php /* tag "B" from line 98 */; ?>
<B><?php echo phptal_escape($ctx->path($ctx->Customer, 'getNewDebt1Print')); ?>
</B></font></td>
		</tr>
	</table>
	<?php /* tag "div" from line 101 */; ?>
<div align="right"><?php /* tag "font" from line 101 */; ?>
<font size="14">(<?php /* tag "span" from line 101 */; ?>
...
<td width="45%" align="center"><?php /* tag "span" from line 107 */; ?>
