<?php 
function tpl_5421374a_ReportDailyStore__asbEtTfGy9ZSV3FyF53PGA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<span><?php echo phptal_escape($ctx->TD->getExportCount( $ctx->Resource->getId() )); ?>
</span></td>
