<?php 
function tpl_54231890_ReportDailySellingCa__twTUgy61UKZ5VvYt2oAuSQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td align="left" colspan="5">TỔNG CỘNG CÓ <?php /* tag "B" from line 44 */; ?>
<B><?php echo phptal_escape($ctx->path($ctx->SessionAll, 'count')); ?>
</B> PHIẾU </td>
											<?php /* tag "td" from line 45 */; ?>
<td align="right"><?php /* tag "B" from line 45 */; ?>
