<?php 
function tpl_52a139c9_Setting__bUfdkwHaogaWNRLQq2PIAg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<p class="ui-li-aside">
								 ( <?php /* tag "strong" from line 226 */; ?>
<strong><?php echo phptal_escape($ctx->path($ctx->Customer, 'getTypePrint')); ?>
</strong> ) - 
								<?php /* tag "strong" from line 227 */; ?>
...
<div data-role="footer" class="footer-docs" data-theme="c"><?php /* tag "p" from line 251 */; ?>
<p>&copy; 2012 SPN Co,ltd.</p></div>
	</div>
...
<div data-role="footer" class="footer-docs" data-theme="c"><?php /* tag "p" from line 291 */; ?>
<p>&copy; 2012 SPN Co,ltd.</p></div>
	</div>
...
<a data-ajax="false"<?php echo $_tmp_1 ?>
>
							<?php /* tag "span" from line 307 */; ?>
<span><?php echo phptal_escape($ctx->path($ctx->repeat, 'Supplier/number')); ?>
</span>. <?php /* tag "span" from line 307 */; ?>
<span><?php echo phptal_escape($ctx->path($ctx->Supplier, 'getName')); ?>
</span>
							<?php /* tag "p" from line 308 */; ?>
<p class="ui-li-aside"><?php /* tag "strong" from line 308 */; ?>
...
<div data-role="footer" class="footer-docs" data-theme="c"><?php /* tag "p" from line 331 */; ?>
<p>&copy; 2012 SPN Co,ltd.</p></div>
	</div>
</body>
</html><?php 
...
Generated by PHPTAL from D:\AppWebServer\SPN_MinhTai\mvc\templates\Setting.html (edit that file instead) */; ?>