<?php 
function tpl_521f9259_App__R7LCh9aDHPMkpJcdv8WuJQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<i class="icon-shopping-cart"></i> trực tuyến									
								</li>
								<?php /* tag "li" from line 59 */; ?>
<li>									
									<?php /* tag "i" from line 60 */; ?>
<i class="icon-shopping-cart"></i> lượt									
								</li>
							</ul>
						</div>
					</div>
