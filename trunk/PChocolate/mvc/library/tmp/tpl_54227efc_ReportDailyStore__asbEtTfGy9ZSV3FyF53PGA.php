<?php 
function tpl_54227efc_ReportDailyStore__asbEtTfGy9ZSV3FyF53PGA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<B><?php echo phptal_escape($ctx->path($ctx->Sum, 'getFormatCurrency')); ?>
</B></td>
											</tr>
										</tbody>
									</table>
