<?php 
function tpl_5424e477_ReportDetailCustomer__TWxAwNTHvr6G9yX3yoxMzA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<span><?php echo phptal_escape($ctx->path($ctx->SValue, 'formatCurrency')); ?>
</span></td>
											</tr>
										</tbody>
									</table>									
