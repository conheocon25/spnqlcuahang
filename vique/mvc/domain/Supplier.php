...
class Supplier extends Object{
	...
	function getIdPrint( ) {return "s".$this->id;}	
	...
	function getResourceAll() {
		...
		$ResourceAll = $mResource->findBySupplier(array($this->getId()));
		return $ResourceAll;
	}
	...
	function getFindResourceByBarcode(){return "/setting/supplier/".$this->getId()."/barcode";}
