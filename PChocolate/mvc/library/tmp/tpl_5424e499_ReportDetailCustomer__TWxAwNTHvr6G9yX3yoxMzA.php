<?php 
function tpl_5424e499_ReportDetailCustomer__TWxAwNTHvr6G9yX3yoxMzA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td><?php /* tag "B" from line 38 */; ?>
<B class="text-right"><?php echo phptal_escape($ctx->path($ctx->SValue, 'formatCurrency')); ?>
</B></td>
											</tr>
										</tbody>
									</table>									
