<?php 
function tpl_52d7573d_ExportCustomerOrderP__FVFau5E2MOqRz3me4wePfQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td width="100%" align="right"><?php /* tag "font" from line 99 */; ?>
<font size="14px">(<?php /* tag "B" from line 99 */; ?>
<B><?php echo phptal_escape($ctx->path($ctx->CL, 'getDebtValueStrPrint')); ?>
</B> <?php /* tag "B" from line 99 */; ?>
<B>đồng</B>)</font></td>
		</tr>
	</table>
