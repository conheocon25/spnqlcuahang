<?php 
function tpl_5421376c_ReportDailyStore__asbEtTfGy9ZSV3FyF53PGA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<span><?php echo phptal_escape($ctx->TD->getImportCount( $ctx->Resource->getId() )); ?>
</span></td>
