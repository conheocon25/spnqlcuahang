<?php 
function tpl_521f9556_App__R7LCh9aDHPMkpJcdv8WuJQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<i class="icon-bar-chart"></i> <?php /* tag "span" from line 60 */; ?>
<span class="bubble"><?php echo phptal_escape(\MVC\Library\Statistic::getCountPrint()); ?>
</span> lượt xem
								</li>
							</ul>
						</div>
