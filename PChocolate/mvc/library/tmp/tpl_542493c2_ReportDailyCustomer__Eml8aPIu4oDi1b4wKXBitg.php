<?php 
function tpl_542493c2_ReportDailyCustomer__Eml8aPIu4oDi1b4wKXBitg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<span><?php echo phptal_escape($ctx->path($ctx->TC, 'getValuePrint')); ?>
</span></a></td>
											</tr><?php 
endforeach ;
$ctx = $tpl->popContext() ;
...
Generated by PHPTAL from G:\AppsWeb\quanly-cuahang.com\PChocolate\mvc\templates\ReportDailyCustomer.html (edit that file instead) */; ?>