<?php 
function tpl_521eb4bb_mAdmin__OlbaOniwaCMfafNyuVljRA_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<span class="label pull-right copyright">&#169; 2012 SPN</span>
 ...
 ?>
<?php 
function tpl_521eb4bb_mAdmin__OlbaOniwaCMfafNyuVljRA_Menu(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<span class="badge badge-info pull-right"><?php echo phptal_escape($ctx->path($ctx->ConfigAll, 'count')); ?>
 ...
 ?>
<?php 
function tpl_521eb4bb_mAdmin__OlbaOniwaCMfafNyuVljRA_PageBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_521eb4bb_mAdmin__OlbaOniwaCMfafNyuVljRA_LocationBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<li class="active"><?php echo phptal_escape($ctx->Title); ?>
 ...
 ?>
<?php 
function tpl_521eb4bb_mAdmin__OlbaOniwaCMfafNyuVljRA_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<span><?php echo phptal_escape(\MVC\Base\SessionRegistry::instance()->getCurrentUser()->getEmail()); ?>
 ...
 ?>
<?php 
function tpl_521eb4bb_mAdmin__OlbaOniwaCMfafNyuVljRA_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script type="text/javascript" language="javascript" src="/mvc/templates/theme/bootstrap/js/bootstrap-datepicker.js"></script>
 ...
 ?>
<?php 
function tpl_521eb4bb_mAdmin__OlbaOniwaCMfafNyuVljRA_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="stylesheet" type="text/css" href="/mvc/templates/theme/bootstrap/css/font-awesome.min.css"/>
 ...
 ?>
<?php 
function tpl_521eb4bb_mAdmin__OlbaOniwaCMfafNyuVljRA_IncludeMETA(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="icon" type="image/png" href="/data/images/icon.png"/>
 ...
 ?>
<?php 
function tpl_521eb4bb_mAdmin__OlbaOniwaCMfafNyuVljRA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
